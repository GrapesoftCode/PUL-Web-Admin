PulAdmin.Controls.Promotion.Grid.prototype.init = function () {
    var self = this;
}

PulAdmin.Controls.Promotion.Grid.prototype.loadRows = function (rows) {
    var self = this;
    var grid = document.getElementById('grdPromotions');
    grid.innerHTML = "";
        ...
        var card = `<div id="` + dataRow.id + `"  class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex no-block align-items-center m-b-15">
                                ...
                                <div class="ml-auto">
                                    <a href="javascript:void(0)" class="link"><i class="far fa-money-bill-alt"></i> ` + dataRow.price + `</a>
                                </div>
                            </div>
...
PulAdmin.Controls.Promotion.Grid.prototype.getCurrentRow = function (htmlRow) {
